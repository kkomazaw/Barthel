//
//  BarthelTableViewController.swift
//  Barthel
//
//  Created by Matsui Keiji on 2017/07/24.
...
class BarthelTableViewController: UITableViewController, UISearchResultsUpdating{
    
    var savedArray:[BarthelData] = []
    ...
    func myCalc(){
        ...
        for j in 0...i{
            ...
            if savedArray[j].memo != nil {
                ...
                unfilteredNFLTeams.append(m + " " + savedArray[j].barthelIndex!)
            }
            else{
                unfilteredNFLTeams.append(myDate + savedArray[j].barthelIndex!)
            }
        } //for j in 0...i
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.performSegue(withIdentifier: "toBarthelDetail", sender: true)
