...
class FIMTableViewController: UITableViewController, UISearchResultsUpdating{
    
    var savedArray:[FIMData] = []
    ...
    func myCalc(){
        ...
        for j in 0...i{
            ...
            if savedArray[j].memo != nil {
                ...
                unfilteredNFLTeams.append(m + " " + savedArray[j].fimIndex!)
            }
            else{
                unfilteredNFLTeams.append(myDate + savedArray[j].fimIndex!)
            }
        }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "ReuseFIM", for: indexPath)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.performSegue(withIdentifier: "toFIMDetail", sender: true)
